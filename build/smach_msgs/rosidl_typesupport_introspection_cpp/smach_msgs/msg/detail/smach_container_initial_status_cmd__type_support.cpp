...
void fetch_function__SmachContainerInitialStatusCmd__initial_states(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__SmachContainerInitialStatusCmd__initial_states(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__SmachContainerInitialStatusCmd__initial_states(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__SmachContainerInitialStatusCmd__initial_states(untyped_member, index));
...
void fetch_function__SmachContainerInitialStatusCmd__local_data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__SmachContainerInitialStatusCmd__local_data(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__SmachContainerInitialStatusCmd__local_data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__SmachContainerInitialStatusCmd__local_data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SmachContainerInitialStatusCmd_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__SmachContainerInitialStatusCmd__initial_states,  // fetch(index, &value) function pointer
    assign_function__SmachContainerInitialStatusCmd__initial_states,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__SmachContainerInitialStatusCmd__local_data,  // fetch(index, &value) function pointer
    assign_function__SmachContainerInitialStatusCmd__local_data,  // assign(index, value) function pointer
